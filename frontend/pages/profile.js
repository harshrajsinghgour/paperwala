...
export default function ProfilePage() {
  return (
    <main className="bg-royal-dark min-h-screen text-white flex flex-col">
      <Navbar />

      <div className="max-w-4xl w-full mx-auto p-6 my-6 space-y-6">
        <div className="bg-royal-card border border-royal-gold/40 rounded-2xl p-6 flex flex-col md:flex-row items-center gap-6 shadow-xl">
          <div className="w-24 h-24 rounded-full bg-royal-gold flex items-center justify-center text-royal-dark font-black text-4xl border-4 border-white/10">
            U
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-royal-card/50 border border-royal-gold/20 p-4 rounded-xl text-center">
          ...
          <div className="bg-royal-card/50 border border-royal-gold/20 p-4 rounded-xl text-center">
            <span className="text-2xl font-bold text-royal-lightGold">142.5</span>
